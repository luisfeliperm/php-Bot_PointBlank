...
/**
 * Class GameClient
 * Socket Sincrono de comunicação com o servidor Game - PointBlank
...
class GameClient 
{
	...
	function __construct()
	{
		...
		$result = socket_connect($this->socket, $GLOBALS['serverList'][1]['addr'], $GLOBALS['serverList'][1]['port']);
		if ($result === false) {
	...
	*/
	function read($buffer) : void{
		...
		require(_DIR_ROOT. "/network/game/read/".$packet.".php");
	}
